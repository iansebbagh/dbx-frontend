...
import walletPrivateKey from "../secret.json" ; // controlling wallet privateKey
...
const signerB = new Wallet(walletPrivateKey.secretKey, providerB);
const signerE = new Wallet(walletPrivateKey.secretKey, providerE);
const signerX = new Wallet(walletPrivateKey.secretKey, providerX);
